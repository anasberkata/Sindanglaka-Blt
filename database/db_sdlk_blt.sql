...
--
-- Host: localhost
-- Generation Time: Jun 14, 2022 at 02:31 PM
...
INSERT INTO `data_blt_penerima` (`id_blt`, `nama_lengkap`, `no_kk`, `no_nik`, `jalan`, `rtrw`, `desa`, `kecamatan`, `kabupaten`, `provinsi`, `kode_pos`, `pekerjaan`, `nama_ibu`, `status_dtks`, `date_created`, `is_active`) VALUES
(1, 'Rendi Dermawan', '3203060198982983', '320306018267736', 'Sindanglaka', '', '', '', '', '', '', 'Buruh', 'Iis', 1, '2022-06-14', 1),
(2, 'Eka Nika', '321010101010', '321010101010', 'Pasantren', '01 / 01', 'Sindanglaka', 'Karangtengah', 'Cianjur', 'Jawa Barat', '43281', 'Pegawai Negeri Sipil', 'Aisyah', 0, '2022-06-14', 1),
(3, 'Asep', '32019029389', '320199201019', 'Pasantren', '02 / 01', 'Sindanglaka', 'Karangtengah', 'Cianjur', 'Jawa Barat', '43281', 'Pegawai Negeri Sipil', 'Iis', 1, '2022-06-14', 1);
...
--
ALTER TABLE `data_blt_penerima`
  MODIFY `id_blt` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
